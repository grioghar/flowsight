...
func (m *Module) Setup(ctx *core.Context) error {
	...
	ctx.Route("GET", "/api/policy", m.apiGet, core.Doc("The policy document, its status and the last plan"), core.Returns("Success", map[string]any{"ok": true}))
	ctx.Route("POST", "/api/policy", m.apiPut, core.Write(), core.Doc("Replace the whole policy document (validated first)"), core.Returns("Success", map[string]any{"ok": true}))
	ctx.Route("GET", "/api/policy/plan", m.apiPlan, core.Doc("Compile onto every provider and show what would change"), core.Returns("Success", map[string]any{"ok": true}))
	ctx.Route("GET", "/api/policy/matches", m.apiMatches, core.Params("name", "policy name", "hours", "window, default 24"),
		core.Doc("What a policy's country rule matches: per device, the far ends in denied countries from the session table (names, domains, bytes), and the packets the firewall's log recorded for the rule"), core.Returns("Success", map[string]any{"ok": true}))
	ctx.Route("POST", "/api/policy/apply", m.apiApply, core.Write(), core.Doc("Apply the plan now (requires enforce)"), core.Returns("Success", map[string]any{"ok": true}))
	ctx.Route("POST", "/api/policy/policy", m.apiSavePolicy, core.Write(), core.Doc("Create or update one policy"), core.Returns("Success", map[string]any{"ok": true}))
	ctx.Route("POST", "/api/policy/policy/delete", m.apiDeletePolicy, core.Write(), core.Doc("Delete one policy"), core.Returns("Success", map[string]any{"ok": true}))
	ctx.Route("POST", "/api/policy/policy/move", m.apiMovePolicy, core.Write(), core.Doc("Reorder a policy"), core.Returns("Success", map[string]any{"ok": true}))
	ctx.Route("GET", "/api/policy/groups", m.apiGetGroups, core.Doc("List all groups"), core.Returns("Success", map[string]any{"ok": true}))
	ctx.Route("GET", "/api/policy/groups/{name}", m.apiGetGroup, core.Doc("Get a group by name"), core.PathParam("name", "string", "Group name", "default"), core.Returns("Success", map[string]any{"ok": true}))
	ctx.Route("POST", "/api/policy/group", m.apiSaveGroup, core.Write(), core.Doc("Create or update a group"), core.Returns("Success", map[string]any{"ok": true}))
	ctx.Route("PUT", "/api/policy/groups/{name}", m.apiUpdateGroup, core.Write(), core.Doc("Update a group"), core.PathParam("name", "string", "Group name", "default"), core.Returns("Success", map[string]any{"ok": true}))
	ctx.Route("POST", "/api/policy/group/delete", m.apiDeleteGroup, core.Write(), core.Doc("Delete a group"), core.Returns("Success", map[string]any{"ok": true}))
	ctx.Route("DELETE", "/api/policy/groups/{name}", m.apiDeleteGroupByName, core.Write(), core.Doc("Delete a group by name"), core.PathParam("name", "string", "Group name", "default"), core.Returns("Success", map[string]any{"ok": true}))
	ctx.Route("GET", "/api/policy/schedules", m.apiGetSchedules, core.Doc("List all schedules"), core.Returns("Success", map[string]any{"ok": true}))
	ctx.Route("GET", "/api/policy/schedules/{name}", m.apiGetSchedule, core.Doc("Get a schedule by name"), core.PathParam("name", "string", "Schedule name", "default"), core.Returns("Success", map[string]any{"ok": true}))
	ctx.Route("POST", "/api/policy/schedule", m.apiSaveSchedule, core.Write(), core.Doc("Create or update a schedule"), core.Returns("Success", map[string]any{"ok": true}))
	ctx.Route("PUT", "/api/policy/schedules/{name}", m.apiUpdateSchedule, core.Write(), core.Doc("Update a schedule"), core.PathParam("name", "string", "Schedule name", "default"), core.Returns("Success", map[string]any{"ok": true}))
	ctx.Route("POST", "/api/policy/schedule/delete", m.apiDeleteSchedule, core.Write(), core.Doc("Delete a schedule"), core.Returns("Success", map[string]any{"ok": true}))
	ctx.Route("DELETE", "/api/policy/schedules/{name}", m.apiDeleteScheduleByName, core.Write(), core.Doc("Delete a schedule by name"), core.PathParam("name", "string", "Schedule name", "default"), core.Returns("Success", map[string]any{"ok": true}))
	ctx.Route("POST", "/api/policy/exclusions", m.apiExclusions, core.Write(), core.Doc("Replace exclusions and options"), core.Returns("Success", map[string]any{"ok": true}))
	ctx.Route("GET", "/api/policy/export", m.apiExport, core.Doc("The document as YAML"), core.Returns("Success", map[string]any{"ok": true}))
	ctx.Route("POST", "/api/policy/import", m.apiImport, core.Write(), core.Doc("Replace the document from YAML or JSON text"), core.Returns("Success", map[string]any{"ok": true}))
	ctx.Route("GET", "/api/policy/capabilities", m.apiCapabilities, core.Doc("Providers, capabilities and what each policy needs"), core.Returns("Success", map[string]any{"ok": true}))
