...
func (m *Module) Setup(ctx *core.Context) error {
	...
	ctx.Route("GET", "/api/alerting/channels", m.apiGetChannels, core.Doc("List all notification channels"), core.Returns("Success", map[string]any{"ok": true}))
	ctx.Route("POST", "/api/alerting/channels", m.apiSetChannels, core.Write(), core.Needs("alerting.notify"), core.Doc("Replace notification channels"), core.Returns("Success", map[string]any{"ok": true}))
	ctx.Route("DELETE", "/api/alerting/channels/{name}", m.apiDeleteChannel, core.Write(), core.Needs("alerting.notify"), core.Doc("Delete a notification channel"), core.Returns("Success", map[string]any{"ok": true}))
	ctx.Route("POST", "/api/alerting/channels/test", m.apiTestChannel, core.Write(), core.Needs("alerting.notify"), core.Doc("Send test message to a channel"), core.Returns("Success", map[string]any{"ok": true}))
	ctx.Route("GET", "/api/alerting/rules", m.apiGetRules, core.Doc("List all alert rules"), core.Returns("Success", map[string]any{"ok": true}))
	ctx.Route("POST", "/api/alerting/rules", m.apiSetRules, core.Write(), core.Doc("Replace alert rules"), core.Returns("Success", map[string]any{"ok": true}))
	ctx.Route("DELETE", "/api/alerting/rules/{name}", m.apiDeleteRule, core.Write(), core.Doc("Delete an alert rule"), core.Returns("Success", map[string]any{"ok": true}))
