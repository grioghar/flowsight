...
| `tight_margin_pct` | Call a placement doubtful within (%) of the floor | int | `15` | A round trip under the speed-of-light floor is impossible; just over it is merely doubtful, because the floor assumes a straight fibre with no equipment on it. Within this margin a placement is flagged rather than accepted. Zero turns the category off. |
